  ...
  <script>
    function ajouterMedicament() {
      ...
      bloc.innerHTML = `
        ...
        <input type="text" name="dosage" placeholder="Dosage (ex: 500mg)" class="form-control mt-2" required>
        <input type="text" name="duree" placeholder="Durée (ex: 5 jours)" class="form-control mt-2" required>
      `;
    ...
    <div class="form-box">
      ...
      <form action="PrescriptionServlet" method="post">
        <div class="mb-3">
          ...
          <input type="text" name="idPrescription" id="idPrescription" class="form-control" required>
        </div>
